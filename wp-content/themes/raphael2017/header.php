...
<div class="menu">
<ul>
<li id="menu-home"><a class="menu-item" href="#home">Home</a></li>
<li id="menu-projects"><a class="menu-item" href="#projects">Projects</a></li>
<li id="menu-contact"><a class="menu-item" href="#contact">Contact</a></li>
</ul>
</div>
            </div>
        </div>
